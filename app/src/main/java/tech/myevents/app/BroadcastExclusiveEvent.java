...
public class BroadcastExclusiveEvent extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {

    CardView cardImage, cardBroadcast, cardPay;
    ImageView ivProfile;
    AutoCompleteTextView autoLocation;
    EditText etName, etVenue, etDetails;
    TextView tvCategory, tvStartTime, tvStartDate, tvEndTime, tvEndDate, tvTickets, tvAudience, tvCost, tvMXECode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_broadcast_exclusive_event);
        ...
        tvMXECode = (TextView) findViewById(R.id.tvMXECode);

        mxeCode = getPromotionCode();
        tvMXECode.setText("MXE code is: " + mxeCode);
        ...
        tvMXECode.setOnClickListener(this);
        ...
        String pageName = "Broadcast Exclusive Event";
    ...
    protected void onResume() {
        super.onResume();
        tvCategory.setText(prefs.getString(AppInfo.EVENT_INTEREST_EX, ""));
        if ((!prefs.getString(AppInfo.EVENT_TICKET_NAME_1_EX, "").equals("")
                && prefs.getInt(AppInfo.EVENT_TICKET_PRICE_1_EX, 0) != 0
                && prefs.getInt(AppInfo.EVENT_TICKET_SEATS_1_EX, 0) != 0)
                &&
                (!prefs.getString(AppInfo.EVENT_TICKET_NAME_2_EX, "").equals("")
                        && prefs.getInt(AppInfo.EVENT_TICKET_PRICE_2_EX, 0) != 0
                        && prefs.getInt(AppInfo.EVENT_TICKET_SEATS_2_EX, 0) != 0)) {
            tvTickets.setText("Selling Double Tickets" + "" + "");
        }
        else if ((!prefs.getString(AppInfo.EVENT_TICKET_NAME_1_EX, "").equals("")
                && prefs.getInt(AppInfo.EVENT_TICKET_PRICE_1_EX, 0) != 0
                && prefs.getInt(AppInfo.EVENT_TICKET_SEATS_1_EX, 0) != 0)
                ||
                (!prefs.getString(AppInfo.EVENT_TICKET_NAME_2_EX, "").equals("")
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tvMXECode:
                ...
                ClipData clip = ClipData.newPlainText("label", mxeCode);
            ...
            case R.id.cardImage:
                ...
                break;
            case R.id.tvTickets:
                Intent intentSell = new Intent(this, TicketSell.class);
                intentSell.putExtra("from", StaticVariables.eventExclusive);
            ...
            case R.id.cardPay:
                ...
                Intent intent1 = new Intent(this, PaymentEvent.class);
                intent1.putExtra("from", StaticVariables.eventExclusive);
    ...
    protected void onPause() {
        ...
        editor.putString(AppInfo.EVENT_LOCATION_EX, autoLocation.getText().toString());
        editor.putString(AppInfo.EVENT_NAME_EX, etName.getText().toString());
        editor.putString(AppInfo.EVENT_VENUE_EX, etVenue.getText().toString());
        editor.putString(AppInfo.EVENT_DETAILS_EX, etDetails.getText().toString());

        editor.putString(AppInfo.EVENT_START_TIME_EX, tvStartTime.getText().toString());
        editor.putString(AppInfo.EVENT_START_DATE_EX, tvStartDate.getText().toString());
        editor.putString(AppInfo.EVENT_END_TIME_EX, tvEndTime.getText().toString());
        editor.putString(AppInfo.EVENT_END_DATE_EX, tvEndDate.getText().toString());
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        editor = prefs.edit();
        editor.putString(AppInfo.EVENT_LOCATION_EX, String.valueOf(parent.getItemAtPosition(position)));
        editor.apply();
    ...
    private void insertBroadcastImage() {
        try {
            StorageReference storageReference = FirebaseStorage.getInstance().getReferenceFromUrl(prefs.getString(AppInfo.EVENT_PROFILE_LINK_EX, ""));
            Glide.with(this)
    ...
    private void putValues() {
        autoLocation.setText(prefs.getString(AppInfo.EVENT_LOCATION_EX, ""));
        etName.setText(prefs.getString(AppInfo.EVENT_NAME_EX, ""));
        etVenue.setText(prefs.getString(AppInfo.EVENT_VENUE_EX, ""));
        etDetails.setText(prefs.getString(AppInfo.EVENT_DETAILS_EX, ""));

        StringBuilder builderAudience = new StringBuilder();
        builderAudience.append("Target Audience:\n ").append(prefs.getInt(AppInfo.EVENT_AUDIENCE_EX, 0));
        tvAudience.setText(builderAudience);

        StringBuilder builderCost = new StringBuilder();
        builderCost.append("Broadcast Cost:\n $").append(prefs.getInt(AppInfo.EVENT_COST_EX, 0));
        tvCost.setText(builderCost);

        tvCategory.setText(prefs.getString(AppInfo.EVENT_INTEREST_EX, ""));
        tvStartTime.setText(prefs.getString(AppInfo.EVENT_START_TIME_EX, ""));
        tvStartDate.setText(prefs.getString(AppInfo.EVENT_START_DATE_EX, ""));
        tvEndTime.setText(prefs.getString(AppInfo.EVENT_END_TIME_EX, ""));
        tvEndDate.setText(prefs.getString(AppInfo.EVENT_END_DATE_EX, ""));
    }
    ...
    private void broadcastEvent() {
        ...
        if ((prefs.getBoolean(AppInfo.EVENT_BROADCAST_PAYMENT_EX, false)
                ||
                (prefs.getInt(AppInfo.EVENT_COST_EX, 2) == 0))
            ...
            int impressions = 0;
            int ticketSpace1 = prefs.getInt(AppInfo.EVENT_TICKET_SEATS_1_EX, 0);
            int ticketSpace2 = prefs.getInt(AppInfo.EVENT_TICKET_SEATS_2_EX, 0);
            int ticketPrice1 = prefs.getInt(AppInfo.EVENT_TICKET_PRICE_1_EX, 0);
            int ticketPrice2 = prefs.getInt(AppInfo.EVENT_TICKET_PRICE_2_EX, 0);
            long broadcastTime = getCurrentTimestamp();
            long startTimestamp = prefs.getLong(AppInfo.EVENT_START_TIMESTAMP_EX, 0);
            long endTimestamp = prefs.getLong(AppInfo.EVENT_END_TIMESTAMP_EX, 0);
            String approvalCode = prefs.getString(AppInfo.EVENT_APPROVAL_CODE_EX, "");
            String interestCode = prefs.getString(AppInfo.EVENT_INTEREST_CODE_EX, "");
            String locationCode, eventLocation = autoLocation.getText().toString();

            if (!prefs.getString(AppInfo.EVENT_BROADCAST_RANGE_CODE_EX, "").equals("National")) {
            ...
            final String profileLink = prefs.getString(AppInfo.EVENT_PROFILE_LINK_EX, "");

            String eventStatus = StaticVariables.eventExclusive;

            String startDate = prefs.getString(AppInfo.EVENT_START_DATE_EX, "");
            String startTime = prefs.getString(AppInfo.EVENT_START_TIME_EX, "");
            String ticketName1 = prefs.getString(AppInfo.EVENT_TICKET_NAME_1_EX, "");
            String ticketName2 = prefs.getString(AppInfo.EVENT_TICKET_NAME_2_EX, "");
            int broadcastCharge = prefs.getInt(AppInfo.EVENT_COST_EX, 2);
            ...
            int availableTickets = prefs.getInt(AppInfo.FREE_TICKETS_EX, 0);

            final FirebaseDatabase database = FirebaseDatabase.getInstance();
            final DatabaseReference ref = database.getReference();
            final String eventKey = ref.child(StaticVariables.childEventsWaiting).child(broadcasterUid).push().getKey();
            String brandName = prefs.getString(AppInfo.BUSINESS_BRAND_NAME, prefs.getString(AppInfo.INDIVIDUAL_USERNAME, ""));
            String brandLink = prefs.getString(AppInfo.BUSINESS_PROFILE_LINK, prefs.getString(AppInfo.INDIVIDUAL_PROFILE_LINK, ""));
            ...
            GetSetterEvent setter = new GetSetterEvent(impressions,
                    ...
                    merchantCode, merchantName, approvalCode, eventLocation,
                    ticketPromoCode, availableTickets, 0, ecocashType, mxeCode, verified, signatureVersion);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                editor = prefs.edit();
                                editor.putBoolean(AppInfo.EVENT_BROADCAST_PAYMENT_EX, false);
                                editor.putString(AppInfo.EVENT_PROFILE_LINK_EX, "");
                                editor.apply();
                                clearValues();
                                ...
                                GetSetterNotifications setterNotifications = new
                                        GetSetterNotifications(StaticVariables.eventExclusive, key, broadcasterUid, eventKey, false);
            ...
            Toast.makeText(getApplicationContext(), "You need to pay first Or (Switch to / Create) a business profile", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void getBroadcastCharge() {
        ...
        final String broadcastRange = prefs.getString(AppInfo.EVENT_BROADCAST_RANGE_CODE_EX, "National");
        final String interestCode = prefs.getString(AppInfo.EVENT_INTEREST_CODE_EX, "1a");
    ...
    private void calculateBroadcastCharge(String location, String businessSize) {
        ...
        broadcastCharge += 10;
        editor = prefs.edit();
        editor.putInt(AppInfo.EVENT_COST_EX, broadcastCharge);
    ...
    private void handlePosterResult(Intent data) {
        ...
        final String previousImage = prefs.getString(AppInfo.EVENT_PROFILE_LINK_EX, "");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                editor.putString(AppInfo.EVENT_PROFILE_LINK_EX, downloadUrl.toString());
                editor.apply();

                try {
                    StorageReference storageReference = FirebaseStorage.getInstance().getReferenceFromUrl(downloadUrl.toString());
                    Glide.with(BroadcastExclusiveEvent.this)
                            .using(new FirebaseImageLoader())
                            .load(storageReference)
                            .crossFade()
                            .into(ivProfile);
    ...
    private void clearValues() {
        ...
        editor = prefs.edit();
        editor.putString(AppInfo.EVENT_INTEREST_EX, "");
        editor.putString(AppInfo.EVENT_INTEREST_CODE_EX, "");
        editor.putString(AppInfo.EVENT_BROADCAST_RANGE_EX, "");
        editor.putString(AppInfo.EVENT_BROADCAST_RANGE_CODE_EX, "");
        editor.putBoolean(AppInfo.EVENT_TICKET_SWITCH_EX, false);
        editor.putString(AppInfo.EVENT_LOCATION_EX, "");
        editor.putString(AppInfo.EVENT_NAME_EX, "");
        editor.putString(AppInfo.EVENT_VENUE_EX, "");
        editor.putString(AppInfo.EVENT_DETAILS_EX, "");
        editor.putString(AppInfo.EVENT_TICKET_NAME_1_EX, "");
        editor.putInt(AppInfo.EVENT_TICKET_PRICE_1_EX, 0);
        editor.putInt(AppInfo.EVENT_TICKET_SEATS_1_EX, 0);
        editor.putString(AppInfo.EVENT_TICKET_NAME_2_EX, "");
        editor.putInt(AppInfo.EVENT_TICKET_PRICE_2_EX, 0);
        editor.putInt(AppInfo.EVENT_TICKET_SEATS_2_EX, 0);
        editor.putString(AppInfo.EVENT_START_TIME_EX, "");
        editor.putString(AppInfo.EVENT_START_DATE_EX, "");
        editor.putString(AppInfo.EVENT_END_TIME_EX, "");
        editor.putString(AppInfo.EVENT_END_DATE_EX, "");
        editor.putInt(AppInfo.EVENT_ECOCACH_MERCHANT_CODE_EX, 0);
        editor.putString(AppInfo.EVENT_ECOCASH_MERCHANT_NAME_EX, "");
        editor.apply();
    }
    ...
    private DatePickerDialog.OnDateSetListener xDateSetListener = new DatePickerDialog.OnDateSetListener() {
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            editor = prefs.edit();
            editor.putString(AppInfo.EVENT_START_DATE_EX, builder);
            editor.apply();
    ...
    private TimePickerDialog.OnTimeSetListener xTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            editor = prefs.edit();
            editor.putString(AppInfo.EVENT_START_TIME_EX, builder);
            editor.apply();
    ...
    private DatePickerDialog.OnDateSetListener yDateSetListener = new DatePickerDialog.OnDateSetListener() {
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            editor = prefs.edit();
            editor.putString(AppInfo.EVENT_END_DATE_EX, builder);
            editor.apply();
    ...
    private TimePickerDialog.OnTimeSetListener yTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            editor = prefs.edit();
            editor.putString(AppInfo.EVENT_END_TIME_EX, builder);
            editor.apply();
    ...
    public void generateTimestamp(String source,int month, int year, int day, int hour, int minute){
        ...
        if(source.equals("x")){
            ...
            editor.putLong(AppInfo.EVENT_START_TIMESTAMP_EX, timestamp);
            editor.apply();
        } else if (source.equals("y")){
            EndStamp = timestamp;
            editor.putLong(AppInfo.EVENT_END_TIMESTAMP_EX, timestamp);
            editor.apply();
        }
    }
