...
public class AdCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeBusinessSize(prefs.getString(AppInfo.AD_INTEREST, ""));

        String pageName = "Ad Category";
    ...
    private void changeBusinessSize(String interest) {
        editor = prefs.edit();
        editor.putString(AppInfo.AD_INTEREST, interest);
        ...
        for (int x = 0; x < StaticVariables.categories.length; x++) {
            if (StaticVariables.categories[x].equals(interest)) {
                ...
                editor.putString(AppInfo.AD_INTEREST_CODE, StaticVariables.interestCodes[x]);
            } else
